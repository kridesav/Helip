    ...
    <Surface style={styles.container} elevation={1}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.buttons}>
          ...
          <Button mode="outlined" icon="account-edit" compact style={styles.button} onPress={navigateToEditProfile}>
            Edit Profile
          </Button>
        </View>
        ...
        <Surface style={styles.bottomlist} elevation={3}>
          <Button icon="calendar" compact contentStyle={styles.button2} onPress={navigateToMyEvents}>
            My Events{" "}
          </Button>
          <Button icon="message" compact contentStyle={styles.button2} onPress={navigateToMyMessages}>
            My Comments
          </Button>
        </Surface>
        <Surface style={styles.bottomlist} elevation={2}>
          <Button icon="account-settings" compact contentStyle={styles.button2} onPress={navigateToSettings}>
            Settings
          </Button>
        </Surface>
      </ScrollView>
