            ...
            <View style={styles.container}>
              ...
              <View style={styles.controls}>
                ...
                <View style={styles.buttons}>
                  <Button icon="check-circle" mode="elevated" title="Modify" style={styles.control} onPress={handleFormSubmit}>
                    Confirm
                  </Button>
                  <Button icon="delete" mode="elevated" title="Delete" style={styles.control} onPress={handleDelete}>
                    Delete
                  </Button>
