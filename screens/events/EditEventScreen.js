...
const EditEventScreen = () => {
  ...
  const handleFormSubmit = () => {
    if (validateInput(value, setErrors)) {
      ...
      Alert.alert("Confirm", "Are you sure you want to modify this event?", [
            ...
            <View style={styles.container}>
              ...
              <View style={styles.controls}>
                ...
                <View style={styles.buttons}>
                  <Button icon="check-circle" mode="contained-tonal" title="Modify" style={styles.control} onPress={handleFormSubmit}>
                    Confirm
                  </Button>
                  <Button icon="delete" mode="contained-tonal" title="Delete" style={styles.control} onPress={handleDelete}>
                    Delete
                  </Button>
                  <Button icon="close-circle" mode="contained-tonal" title="Cancel" style={styles.control} onPress={() => navigation.goBack()}>
                    Cancel
                  </Button>
                </View>
              </View>
