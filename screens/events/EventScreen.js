      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.buttons}>
          {isCreator ? (
            ...
            <>
              <Button icon="cancel" mode="elevated" title="Cancel Join" style={styles.control} onPress={handleCancelJoinPress} disabled={isCanceling}>
            ...
            <Button title="Join" icon="check-circle" mode="elevated" style={styles.control} onPress={handleJoinPress} disabled={isJoining || isUser}>
