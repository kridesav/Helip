      ...
      <View style={styles.content}>
        <Surface elevation={5} style={styles.bottomlist}>
          <View style={styles.switchContainer}>
            ...
            <Switch style={styles.input} value={location} onValueChange={onToggleLocation} disabled />
          </View>
          <View style={styles.switchContainer}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Switch style={styles.input} value={notifications} onValueChange={onToggleNotifications} disabled />
          </View>
          <View style={styles.switchContainer}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Switch style={styles.input} value={themeMode === "dark"} onValueChange={onToggleNightMode} />
          </View>
          <Portal>
            <Dialog visible={deleteDialog} onDismiss={() => hideDialog(false)}>
              ...
              <Dialog.Content>
                <Text variant="bodyMedium">Are you sure you want to delete your account? This action is permanent.</Text>
              </Dialog.Content>
              <Dialog.Actions>
