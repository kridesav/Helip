...
export function getAllSportsIcons() {
  return [
    {name: 'footballIcon', uri: footballIcon},
    {name: 'gymIcon', uri: gymIcon},
    {name: 'swimmingIcon', uri: swimmingIcon},
    {name: 'defaultIcon', uri: defaultIcon},
    {name: 'golfIcon', uri: basketballIcon},
    {name: 'iceSkatingIcon', uri: iceSkatingIcon},
    {name: 'basketballIcon', uri: basketballIcon},
    {name: 'runningIcon', uri: runningIcon},
    {name: 'tennisIcon', uri: tennisIcon},
    {name: 'hockeyIcon', uri: hockeyIcon},
    {name: 'boxingIcon', uri: boxingIcon},
    {name: 'volleyballIcon', uri: volleyballIcon},
    {name: 'infoIcon', uri: infoIcon},
    {name: 'skateIcon', uri: skateIcon},
    {name: 'danceIcon', uri: danceIcon},
    {name: 'baseballIcon', uri: baseballIcon},
    {name: 'motorsportsIcon', uri: motorsportsIcon},
    {name: 'petsIcon', uri: petsIcon}
  ]
}
